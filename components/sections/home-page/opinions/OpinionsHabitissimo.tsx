...
const data: Opinion[] = [
  {
    date: getReadableDate(new Date("2023-4-1")),
    name: "Jose",
  ...
  {
    date: getReadableDate(new Date("2023-3-1")),
    name: "Avi",
  ...
  {
    date: getReadableDate(new Date("2022-9-13")),
  ...
  {
    date: getReadableDate(new Date("2022-5-13")),
    name: `Marta`,
