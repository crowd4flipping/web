...
export const NewsLetterSuscription = ({ width }) => {
  const api =
  ...
  return (
    <div className={styles.suscription_card}>
      <div
        className={
          width === "blog_page"
            ? `${styles.suscription_card_header} ${styles.suscription_card_header_blog_page}`
            : styles.suscription_card_header
        }
      >
      ...
      {!success ? (
        <>
          ...
          <div className={styles.suscription_card_footer}>
            {submit ? (
              ...
              >
                <div className={styles.suscription_card_button}>
        ...
        >
          <span>
            Hola, gracias por la suscripción, recibirás pronto nuevas
            oportunidades.
          </span>
        </motion.div>
      )}
